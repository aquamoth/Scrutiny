...
(function () {
    ...
    var Karma = function (socket, iframe, opener, navigator, location) {
        ...
        var returnUrl = undefined;//queryParams['return_url' + ''] || null;
...
//    var util = require('./util');
    ...
    window.karma = new Karma(window.rpc, $('#context').get(0), window.open, window.navigator, window.location);
...
//},{}]},{},[3])
    ...
    $(function () {
        window.rpc.run(onConnected, onDisconnected);
        window.rpc.on('Clients', onClientsUpdate);
        window.rpc.on('Load', onLoad);
        ...
        //            case 'Load': onLoad(this.Data); break;
        //            default:
        ...
        function onLoad(data) {
            var url = data;
            console.log('Requesing IFrame to load url: ' + url);
